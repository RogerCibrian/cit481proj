...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/PC_games/Dying_Light.css"/>
...
<body>
    ...
    <!----end of Navigation Bar-->
	 <div class="bg"></div>
        <div class="DYINGLIGHT">
        <div class="transbox_dyinglight">
            <ul>
              <h2> Dying Light </h2>
              <br />
              <br />
              ...
              <li>Initial Release Date: January 28, 2015</li>
              <li>Developed  Techland</li>
              <li>Published by Warner Bros. Interactive </li>
               <li>
                <a href="https://dyinglightgame.com/dyinglight/buy">
                <strong>Available in the Dying Light Official Site</strong></a>
               </li> 
...
<div class="transbox">
            <p> 
                Dying Light is a  survival horror video game where the game's story revolves around 
                an undercover agent named Kyle Crane who is sent to infiltrate a quarantine zone in an 
                Middle-eastern city called Harran. It features an enemy-infested, open-world city with
                 a dynamic day-night cycle, in which zombie would be slow and clumsy during day time 
                 but become extremely aggressive at night. The game is set in an open world 
                 environment, which can be freely explored by the player. The gameplay is focused on 
                 weapons-based combat and free running, allowing players to either fight or flight 
                 when they are presented with dangers. The game also features an asymmetrical
