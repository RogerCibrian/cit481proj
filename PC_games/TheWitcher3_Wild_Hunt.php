...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/PC_games/TheWitcher3_Wild_Hunt.css"/>
...
<body>
	...
	<div class="bg"></div>
        <div class="THEWITCHER3WILDHUNT">
        <div class="transbox_witcher3wildhunt">
            <ul>
              ...
              <li>Initial Release Date: May 19, 2015</li>
              <li>Developed  by CD Projekt Red</li>
              <li> Published by CD Projekt</li>
               <li>
                <a href="https://buy.thewitcher.com/en_us/">
                <strong>Available in CD Projekt Official Site</strong></a>
               </li> 
            </ul>
...
<div class="transbox">
             <p> 
                The Witcher 3: Wild Hunt is a action role-playing game that takes place in a fictional 
                fantasy world based on Slavonic mythology. Players control protagonist Geralt of 
                Rivia, a monster slayer for hire known as a Witcher who is looking for his missing 
                adopted daughter on the run from the Wild Hunt, an otherworldly force determined to 
                capture her. Players battle the game's many dangers with weapons and magic, interact
                 with non-player characters, and complete quests to acquire experience points and
                  gold, which are used to increase Geralt's abilities and purchase equipment. Its 
                  central story has several endings, determined by the player's choices at certain 
                  points in the game.
              </p> 
        </div> 
