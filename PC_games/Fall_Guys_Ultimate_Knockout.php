   ...
   <style>
        ...
        * {
        ...
        div.transbox_fallguysknockout {
                ...
                height: 277px;
                text-indent: 185px;
                background: url('/PC_games/220px-Fall_Guys_cover.jpg');
...
<body>
    ...
    <!----end of Navigation Bar-->
	 <div class="bg"></div>
        <div class="FALLGUYSKNOCKOUT">
        <div class="transbox_fallguysknockout">
            <ul>
              ...
              <li>Initial Release Date: August 4, 2020</li>
              <li>Developed  by Mediatonic</li>
              <li> Published by Devolver Digital</li>
               <li>
                <a href="https://store.steampowered.com/app/1097150/Fall_Guys_Ultimate_Knockout/">
...
<div class="transbox">
            <p> 
                Fall Guys is a massively multiplayer party game with up to 60 players online in 
                a free-for-all struggle through round after round of escalating chaos until one 
                victor remains! It flings hordes of contestants together online in a mad dash 
                through round after round of escalating chaos until one victor remains! Battle 
                bizarre obstacles, shove through unruly competitors, and overcome the unbending 
                laws of physics as you stumble towards greatness. Leave your dignity at the door
                 and prepare for hilarious failure in your quest to claim the crown! Dive into a 
                 series of ridiculous challenges and wild obstacle courses with masses of other 
                 competitors online, all with the hopes of making the cut and advancing to the 
                 next round of mayhem. Shift between competitive free-for-alls and cooperative 
                 challenges where the losing team all get eliminated!
              </p>  
        </div> 
