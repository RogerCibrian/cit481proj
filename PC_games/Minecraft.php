...
div.transbox_minecraft    {
        ...
        height: 277px;
        text-indent: 185px;
        background: url('/PC_games/220px-Minecraft_cover.png');
	 ...
	 <div class="bg"></div>
        ...
        <div class="transbox_minecraft">
            <ul>
              ...
              <li>Initial Release Date: November 18, 2011</li>
              <li>Developed by Mojang Studios </li>
              <li>Published by Mojang Studios, Microsoft Studios, Sony Entertainment</li>
            
               <li>
                <a href="https://www.minecraft.net/en-us/store/minecraft-java-edition">
                <strong>Available in the Minecraft Store</strong></a>
               </li> 
            </ul>
...
<div class="transbox">
             <p> 
                ...
                infinite terrain, and may discover and extract raw materials, craft tools and 
                items, and build structures or earthworks. Depending on game mode, players can 
                fight computer-controlled "mobs", as well as cooperate with or compete against 
                other players in the same world. However, there is an achievement system, known 
                as "advancements" in the Java Edition of the game Game modes include a survival 
                mode, in which players must acquire resources to build the world and maintain 
                health, and a creative mode, where players have unlimited resources. Players can 
                modify the game to create new gameplay mechanics, items, and assets.
              </p> 
        </div> 
