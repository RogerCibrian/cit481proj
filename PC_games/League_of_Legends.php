...
<body>
    ...
    <!----end of Navigation Bar-->
	 <div class="bg"></div>
        ...
        <div class="transbox_leagueoflegends">
            <ul>
              ...
              <li>Initial Release Date: October 27, 2009</li>
              <li>Developed  Riot Games</li>
              <li>Published by Riot Games, Tencent, Garena </li>
              
            
               <li>
                <a href="https://signup.na.leagueoflegends.com/en/signup/redownload?page_referrer=index">
                <strong>Available in the League of League's Official Site</strong></a>
               </li> 
            </ul>
...
<div class="transbox">
            <p> 
                League of Legends (LoL) is a multiplayer online battle arena video game (MOBA) in a 
                three-dimensional isometric perspective where players assume the role of a "champion"
                 with unique abilities and battle against a team of other player- or computer-controlled 
                 champions. The goal is usually to destroy the opposing team's Nexus, a structure that 
                 lies at the heart of a base protected by defensive structures, although other distinct 
                 game modes exist as well with varying objectives, rules, and maps. Champions span a 
                 variety of roles and blend a variety of fantasy tropes, tied to a fictional universe 
