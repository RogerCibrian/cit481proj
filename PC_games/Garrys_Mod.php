...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/PC_games/Garrys_Mod.css"/>
...
<body>
    ...
    <!----end of Navigation Bar-->
	 <div class="bg"></div>
        <div class="GARRYSMOD">
        <div class="transbox_garrysmod">
            <ul>
              <h2>Garry's Mod</h2>
              <br />
              <br />
              <br />
              <li>Initial Release Date: November 29, 2006</li>
              <li>Developed  by Facepunch Studios</li>
              <li> Published by Valve</li>
               <li>
...
<div class="transbox">
               <p> 
                Garry's Mod (GMod) is a sandbox game and has no set objectives and provides the 
                player with a world to freely manipulate. The player is able to spawn non-player 
                characters, ragdolls, and props, and interact with them by various means. Using the 
                physics gun, ragdolls and props can be picked up, rotated, and frozen in place. The 
                tool gun is a multi-purpose item for various tasks, such as welding and constraining
                 props together, and altering the facial expressions of ragdolls.
              </p> 
        </div> 
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line202" rows="2" name="comment"
