...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/PC_games/Doom_Eternal.css"/>
...
<body>
	...
	<div class="bg"></div>
        <div class="DOOMETERNAL">
        <div class="transbox_doometernal">
            <ul>
              <h2>Doom: Eternal</h2>
              <br />
         
              <li>Initial Release Date: March 20, 2020</li>
              <li>Developed  by id Software</li>
              <li> Published by Bethesda Softworks</li>
               <li>
               ...
               <li>
                <a href="https://www.target.com/p/doom-eternal-pc-game/-/A-53742055">
                <strong>Available at Target </strong></a>
               </li> 
            </ul>
...
<div class="transbox">
             <p> 
                Doom Eternal is a first-person shooter video game where it is set some time after
                 the events of the 2016 game, the story follows the Doom Slayer once again, on a 
                 mission to end Hell's consumption of Earth and foil the alien Maykrs' plans to 
                 exterminate humanity. 
                 Players once again take on the role of the Doomguy (Doom Slayer) who battles the
                  demonic forces of Hell, from a first-person perspective. The game continues its 
                  predecessor's emphasis on "push-forward" combat, encouraging the player to 
                  aggressively engage enemies in order to acquire health, ammo, and armor. The player 
                  has access to various firearms, such as the Combat Shotgun, Super Shotgun, Heavy 
                  Cannon, Rocket Launcher, Plasma Rifle, Chaingun, BFG 9000, and Ballista. New movement 
                  mechanics such as wall-climbing, dash moves, and horizontal bars to swing from have 
                  also been introduced. Like Doom, Doom Eternal invites the player to develop simple 
                  tactics. As the game gets harder, the player needs to use the advantages of fight 
                  arenas, and their bonuses, smarter. They also need to decide which enemy has to be 
                  killed first and how to move on the battlefield.
              </p> 
        </div> 
