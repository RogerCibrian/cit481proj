...
div.transbox_diabloiii    {
        ...
        height: 277px;
        text-indent: 185px;
        background: url('/PC_games/220px-Diablo_III_cover.png');
	 ...
	 <div class="bg"></div>
        ...
        <div class="transbox_diabloiii">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: May 15, 2012</li>
              <li>Developed & Published by Blizzard Entertainment</li>
            
               <li>
                <a href="https://us.shop.battle.net/en-us/product/diablo-iii?p=38789">
...
<div class="transbox">
            <p> Diablo III is a hack-and-slash action role-playing game where players can choose from 
              a variety on what class they would like to play as. Players choose to play as one of seven character classes – Barbarian, Crusader, Demon 
                Hunter, Monk, Necromancer, Witch Doctor, or Wizard – and are tasked with defeating the 
                Lord of Terror, Diablo, as in previous games in the series.
                In the beginning, the game takes place in Sanctuary, the dark fantasy world of the 
                Diablo Series, twenty years after the events of Diablo II. Twenty years have passed since
                 the Prime Evils were defeated and banished from the world of Sanctuary. Now, you must 
                 return to where it all began – the town of Tristram – and investigate rumors of a fallen
                  star, for this is the first sign of evil’s rebirth, and an omen that the End Times have
                   begun.
