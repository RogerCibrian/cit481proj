...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Nintendo_games/resident_evil_4.css"/>
...
<body>
 ...
 <div class="bg"></div>
        <div class="RESIDENTEVIL4">
        <div class="transbox_residentevil4">
            <ul>
              <h2>Resident Evil 4</h2>
              <br />
	      <br>
              <br />
              <li>Initial Release Date: January 11, 2005</li>
              <li>Developed by Capcom Production Studio 4</li>
              <li> Published by Capcom</li>
               <li>
		  <a href="https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=Resident+Evil+4++Nintendo+Gamcube&_sacat=0&LH_TitleDesc=0&_odkw=resident+evil+4+-+nintendo+gamecube&_osacat=0">
...
<div class="transbox">
            <p>
		 Resident Evil 4 is a third-person shooter game and a GameCube exclusive. In this game, players
                 control U.S. government special agent Leon S. Kennedy, who is sent on a mission to rescue the
                  U.S. president's daughter Ashley Graham, who has been kidnapped by a cult. In a rural part 
                  of Europe, Leon fights hordes of villagers infected by a mind-controlling parasite, and 
                  reunites with the spy Ada Wong. The gameplay focuses on action and shootouts with fewer 
                  survival horror elements. The camera is placed behind Leon and zooms in for an 
                  over-the-shoulder view when aiming a weapon, or a first-person view when aiming with a
                   sniper rifle. There is no crosshair for firearms; instead, every firearm has a laser 
                   sight. Unlike previous games where players can only shoot straight, up, or down, players
                    have more options. For example, shots to the feet can cause enemies to stumble, and 
                    shots to the arms can make them drop their weapons. Players can also shoot down 
                    projectiles like thrown axes or scythes.
