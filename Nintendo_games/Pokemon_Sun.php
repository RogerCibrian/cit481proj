   ...
   <style>
          ...
          * {
          ...
          div.transbox_pokemonsun {
                  ...
                  height: 244px;
                  text-indent: 185px;
                  background: url('/Nintendo_games/3DS/Pokemon_Sun_Boxart.jpg');
...
<body>
 ...
 <div class="bg"></div>
        <div class="POKEMONSUN">
        <div class="transbox_pokemonsun">
            <ul>
              <h2>Pokémon Sun</h2>
              <br />


              <li>Initial Release Date: November 18, 2016   </li>
              <li>Developed  by Game Freak</li>
              <li> Published by The Pokemon Company and Nintendo</li>
               <li>
                <a href="https://www.amazon.com/s?k=Pok%C3%A9mon+Sun-+Nintendo+3DS&i=videogames&ref=nb_sb_noss">
                <strong>Available in the Amazon Store </strong></a>
               </li>
               <p style="text-indent:195px;">or</p>
               <li>
		   <a href="https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=Pokemon+Sun+Nintendo+3DS&_sacat=0&LH_TitleDesc=0&_osacat=0&_odkw=Pok%C3%A9mon+Platinum++-+Nintendo+DS">
...
<div class="transbox">
            <p>
	       Like previous Pokemon installments, Pokemon Sun follows the journey of a young Pokémon 
                trainer, taking place in the Alola region—based on Hawaii—with the objective of the games
                 being to complete the island challenge and thwart the schemes of Team Skull, and later
                  the Aether Foundation, all while attempting to challenge various Pokémon trainers of 
                  gradually increasing difficulty. Pokemon Sun (and Pokemon Moon) introduced 81 new 
                  Pokémon species, and new features such as Alolan forms of previous generation 
                  Pokémon, powerful moves known as Z-Moves, alien creatures known as Ultra Beasts, updated
                   battle and training mechanics, and improved polygonal 3D graphics. Players are also able
                    to battle and trade Pokémon with other human players using the Nintendo 3DS' connectivity
                    features. As with previous games in the series, certain Pokémon are only obtainable in 
                    either Pokemon Sun or Moon, with players encouraged to trade with others in order to 
                    obtain all Pokémon from both versions.
