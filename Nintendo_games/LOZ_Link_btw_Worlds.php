...
div.transbox_lozlinkbtwworlds {
        ...
        height: 244px;
        text-indent: 185px;
        background: url('/Nintendo_games/3DS/220px-The_Legend_of_Zelda_A_Link_Between_Worlds_NA_cover.jpg');
...
<body>
    ...
    <div class="bg"></div>
        <div class="LOZLINKBTWWORLDS">
        <div class="transbox_lozlinkbtwworlds">
            <ul>
              <h2>The Legend of Zelda: A Link Between Worlds</h2>
              <br />


              <li>Initial Release Date: November 22, 2013 </li>
              <li>Developed  by Nintendo EAD</li>
              <li> Published by Nintendo</li>
               <li>
                <a href="https://www.nintendo.com/games/detail/the-legend-of-zelda-a-link-between-worlds-3ds/">
                <strong>Available in the Nintendo Official Site </strong></a>
               </li>
               <p style="text-indent:195px;">or</p>
               <li>
                <a href="https://www.amazon.com/s?k=The+Legend+of+Zelda%3A+A+Link+Between+Worlds-+Nintendo+3DS&i=videogames&ref=nb_sb_noss_2">
...
<div class="transbox">
              <p> 
                The Legend of Zelda: A Link Between Worlds is an action-adventure game where players
                 play as a young adventurer, Link, who sets out to restore peace to the kingdom of
                  Hyrule after the evil sorcerer Yuga captures Princess Zelda and escapes through a
                   rift to the ruined world of Lorule. Yuga seeks to kidnap the Seven Sages and use 
                   their power to resurrect the Demon King Ganon. Link is granted the ability to merge 
                   onto walls as a painting after obtaining a magic bracelet and encountering Yuga, which
                    allows Link to reach previously inaccessible areas and travel between Hyrule and 
                    Lorule.
              </p> 
        </div> 
