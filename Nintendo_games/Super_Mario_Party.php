...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Nintendo_games/super_mario_party.css"/>
...
<body>
 ...
 <div class="bg"></div>
        <div class="SUPERMARIOPARTY">
        <div class="transbox_supermarioparty">
            <ul>
              <h2>Super Mario Party</h2>
              <br />

              <li>Initial Release Date: October 5, 2018 </li>
              <li>Developed  by NDcube</li>
              <li> Published by Nintendo</li>
               <li>
                <a href="https://www.nintendo.com/games/detail/super-mario-party-switch/">
                <strong>Available in the Nintendo Official Site </strong></a>
               </li>
               <p class="p_text_store">or</p>
               <li>
                <a href="https://www.walmart.com/ip/Super-Mario-Party-Nintendo-Nintendo-Switch/986121913">
...
<div class="transbox">
            <p>
		 Super Mario Party has a wide variety of minigames. A second mode, known as Partner 
                Party, has two teams of two players also searching for stars on a free-movement board 
                similar to those in Mario Party: Star Rush. The game can be played with only one 
                Joy-Con controller per player, allowing two players to play together with only one 
                Switch system, which comes with two Joy-Con. Super Mario Party also takes advantage 
                of the Switch's local wireless capabilities, allowing teams to play from separate 
                Switch consoles and allowing multiple Switch consoles to be arranged and synchronized
                 to create larger, multi-monitor environments in a mode called "Toad's Rec Room".

                Super Mario Party features online multiplayer for the first time in the Mario Party 
                series. While Party Mode's board games are restricted to offline play, players are 
                able to play the game's 80 minigames with other players either locally or online 
                independent of the board games in the game's "Online Mariothon" mode. In the Online
                 Mariothon mode, players compete in five randomly-selected minigames aiming to get the 
                 highest score. It also features leader boards and a ranking system, as well as rewards
                  that the players can receive for playing the mode. 
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line220" rows="2" name="comment"
