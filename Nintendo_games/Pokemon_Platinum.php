...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Nintendo_games/pokemon_platinum.css"/>
...
<body>
    ...
    <!----end of Navigation Bar-->
       <div class="bg"></div>
        <div class="POKEMONPLATINUM">
        <div class="transbox_pokemonplatinum">
	  <ul>
              <h2>Pokémon Platinum</h2>
              <br />
              <li>Initial Release Date: March 22, 2009   </li>
              <li>Developed  by Game Freak</li>
              <li> Published by The Pokemon Company and Nintendo</li>
               <li>
		 <a href="https://www.amazon.com/s?k=Pok%C3%A9mon+Platinum+-+Nintendo+DS&i=videogames&ref=nb_sb_noss">
                <strong>Available in the Amazon Store </strong></a>
               </li>
               <p class="p_text_store">or</p>
               <li>
		<a href="https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2380057.m570.l1313&_nkw=Pok%C3%A9mon+Platinum++-+Nintendo+DS&_sacat=0">
...
<div class="transbox">
            <p>
      In Platinum, players control either a male or female character and start with one of
                 three Pokémon given to them from Professor Rowan. The mascot Pokémon is Giratina, who 
                 plays a central role in the game's plot. While it only had one form in Pokemon Diamond and 
                 Pearl, it is given a new alternate form alongside a new area called the Distortion 
                 World, which features altered physics from the normal land of Sinnoh, where the game 
                 takes place. The gameplay stays true to traditional Pokémon mechanics. Players explore
                  a large area, which ranges from mountains to bodies of water, grasslands, populated
                   areas, and snowy expanses. Similar to previous titles, players have their Pokémon 
                   fight turn-based battles against other Pokémon.
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line212" rows="2" name="comment"
