...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Nintendo_games/pokemon_sword.css"/>
        ...
        <div class="transbox_pokemonsword">
            <ul>
              ...
              <li> Published by The Pokemon Company and Nintendo</li>
               <li>
                <a href="Nintendo: https://www.nintendo.com/games/detail/pokemon-sword-switch/">
                <strong>Available in the Nintendo Official Site </strong></a>
               </li>
               <p class="p_text_store">or</p>
               <li>
                <a href="https://www.walmart.com/ip/Pokemon-Sword-Nintendo-Nintendo-Switch/874127409 ">
...
<div class="transbox">
            <p>
 Pokémon Sword is a role-playing video games with adventure elements, and in most cases
                 it is presented in a fixed camera, third-person perspective; in certain instances free 
                 camera movement is available. The player controls a young trainer who goes on a quest 
                 to catch and train creatures known as Pokémon, and win battles against other trainers.
                  By defeating opposing Pokémon in turn-based battles, the player's Pokémon gains 
                  experience, allowing them to level up and increase their battle statistics, learn
                   new battle techniques, and in some cases, evolve into more powerful Pokémon. Players 
                   can capture wild Pokémon, found during wild encounters, by weakening them in battle 
                   and catching them with Poké Balls, allowing them to be added to their party. Players 
                   are also able to battle and trade Pokémon with other human players using the Nintendo
                    Switch connectivity features. As with previous games in the series, certain Pokémon
                     are only obtainable in either Sword or Shield, with players encouraged to trade with
                      others in order to obtain all Pokémon from both versions

                Several new features for the games are also firsts for the series, including cooperative
                 raid encounters, akin to those seen in Pokémon Go; the Wild Area, a fully explorable 
                 open world area with free camera movement and dynamic weather, which has implications
                  on which Pokémon species appear at a given time; and "Dynamaxing" and "Gigantamaxing",
                   both of which temporarily allow Pokémon to grow to larger sizes. Gigantamaxing is 
                   limited to select Pokémon and feature different forms from the Pokémon's normal 
                   appearance.
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line223" rows="2" name="comment"
