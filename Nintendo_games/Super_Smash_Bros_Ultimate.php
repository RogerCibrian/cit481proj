  ...
  <link rel="stylesheet" href="../style2.css" />
   <style>
          ...
          * {
          ...
          div.transbox_supersmashbrosultimate {
              margin: 30px;
              ...
              height: 244px;
              text-indent: 185px;
              background: url('/Nintendo_games/Switch/220px-Super_Smash_Bros._Ultimate.jpg');
...
<body>
  ...
  <div class="bg"></div>
        ...
        <div class="transbox_supersmashbrosultimate">
            <ul>
              <h2>Super Smash Bros Ultimate</h2>
              <br />
              <br />

              <li>Initial Release Date: December 7, 2018   </li>
              <li>Developed  by Bandai Namco Studios, Sora Ltd</li>
              <li> Published by Nintendo</li>
               <li>
                <a href="https://www.nintendo.com/games/detail/super-smash-bros-ultimate-switch/">
                <strong>Available in the Nintendo Official Site </strong></a>
               </li>
               <p style="text-indent:195px;">or</p>
               <li>
                <a href="https://www.walmart.com/ip/Super-Smash-Bros-Ultimate-Nintendo-Nintendo-Switch-045496592998/467273231">
...
<div class="transbox">
            <p>
		 Super Smash Bros. Ultimate is a fighting game for up to eight players in which 
                characters from Nintendo games and other third-party franchises must try to knock 
                each other out of an arena. Each player has a percentage meter, which raises when 
                they take damage, making them easier to launch in the air and out of the arena. The 
                game follows the series' traditional style of gameplay: controlling one of the various 
                characters, players must use differing attacks to weaken their opponents and knock them 
                out of an arena. It features a wide variety of game modes, including a campaign for 
                single-player and multiplayer versus modes. Ultimate features over 80 playable 
                fighters, including everyone from all previous Super Smash Bros. games, alongside 
                several newcomers. In addition to returning modes such as Classic, Special Smash, and 
                Home-Run Contest, new modes are added to the game include Smashdown, where each 
                character can only be played once, Squad Strike, where players battle in teams of
                 multiple characters, and a tournament mode that allows up to 32 players to battle
                  in playoff brackets.
