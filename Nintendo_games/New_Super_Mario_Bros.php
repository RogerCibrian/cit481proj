...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Nintendo_games/New_super_mario_bros.css"/>
...
<body>
    ...
    <div class="bg"></div>
        <div class="NEWSUPERMARIOBROS">
        <div class="transbox_newsupermariobros">
            <ul>
              <h2>New Super Mario Bros.</h2>
              <br />
	      <br>
              <li>Initial Release Date: May 15, 2006  </li>
              <li>Developed  by Nintendo EAD Group No.4</li>
              <li> Published by Nintendo</li>
               <li>
                <a href="https://www.amazon.com/s?k=New+Super+Mario+Bros.+-+Nintendo+DS&i=videogames&ref=nb_sb_noss">
...
<div class="transbox">
   <p> 
                New Super Mario Bros follows the Super Mario franchise where it follows Mario as 
                he fights his way through Bowser's henchmen to rescue Princess Peach. Mario has 
                access to several power-ups that help him complete his quest, including the Super 
                Mushroom, the Fire Flower, and the Starman, each giving him unique abilities. While 
                traveling through eight worlds with a total of 80 levels, Mario must defeat
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line204" rows="2" name="comment"
