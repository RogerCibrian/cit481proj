  ...
  <link rel="stylesheet" href="../style2.css" />
   <style>
        ...
        * {
        ...
        div.transbox_mariokart8 {
                margin: 30px;
                border: 1px solid black;
                margin: 0rem;
                padding: 0.1 rem;
                text-indent: 210px;
                background: url('/Nintendo_games/Switch/220px-MarioKart8Boxart.jpg');
...
<body>
    ...
    <div class="bg"></div>
        <div class="MARIOKART8">
         <div class="transbox_mariokart8">
              <ul>
              <h2>Mario Kart 8</h2>
              <br/>
    <li>Initial Release Date: May 30, 2014 </li>
              <li>Developed  by Nintendo EAD</li>
              <li> Published by Nintendo</li>
               <li>
                <a href="https://www.nintendo.com/games/detail/mario-kart-8-deluxe-switch/">
                <strong>Available in the Nintendo Official Site </strong></a>
               </li>
               <p style="text-indent:210px;">or</p>
               <li>
                <a href="https://www.walmart.com/ip/Mario-Kart-8-Deluxe-Nintendo-Nintendo-Switch-045496590475/55432571">
...
<div class="transbox">
             <p> 
                The game continues the traditional gameplay of the Mario Kart series, in which characters 
                from the Mario universe race against each other in go-karts, attempting to hinder their 
                opponents or improve their racing performance using various tools found in item boxes. In 
                addition, the game includes four different difficulties, which can be selected before 
                beginning the race to challenge players. Returning features from previous installments 
                include motorbikes and 12-player racing from Mario Kart Wii, as well as hang 
                gliders, underwater racing and vehicle customization from Mario Kart 7.
            </p>
                <p>Mario Kart 8's new features include anti-gravity racing, in which certain parts of a
                 track can allow racers to drive on walls and ceilings. During these sections, players
                 can bump into other racers or special bumpers to trigger a Spin Boost, which gives them an
                  extra speed boost. New characters include The Koopalings and Pink Gold Peach. There are 
                  four new items: the Boomerang Flower, which can be thrown to attack players, the Piranha
                   Plant, which attacks nearby racers and obstacles, the Crazy Eight, which gives the user
                    eight items, and the Super Horn, which can be used both to attack nearby opponents and 
                    defend against items, including the previously nearly unavoidable Spiny Shell.The game 
                    features 32 tracks in eight cups (Mushroom, Flower, Star, Special, Shell, Banana, Leaf,
                 and Lightning), with an additional 16 later released as downloadable content (DLC) in four 
                 asditional cups: Egg, Triforce, Crossing, and Bell. Also, along with local multiplayer, Mario 
                 Kart 8 supports online multiplayer with up to twelve players and voice chat outside of
                  races, however voice chat is only available with friends online.
...
parent.addEventListener('click', event => {
 ...
 $('.userrating-form').submit(function(e){e.preventDefault();
        $.ajax({
