  ...
  <link rel="stylesheet" href="../style2.css" />
   <style>
      ...
      * {
      ...
      div.transbox_justdance {
          margin: 30px;
              border: 1px solid black;
              margin: 0rem;
              padding: 0.1 rem;
              text-indent: 210px;
              background: url('/Nintendo_games/Wii/just-dance-wii-00a.jpg');
...
<body>
    ...
    <div class="bg"></div>
        <div class="JUSTDANCE">
        <div class="transbox_justdance">
            <ul>
              <h2>Just Dance</h2>
              <br />
              <li>Initial Release Date: November 17, 2009  </li>
              <li>Developed  by Ubisoft Paris and Ubisoft Milan </li>
              <li> Published by Ubisoft</li>
               <li>
     	         <a href="https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=Just+Dance+-+Nintendo+Wii+2009&_sacat=0&LH_TitleDesc=0&_osacat=0&_odkw=Just+Dance+-+Nintendo+Wii">
...
<div class="transbox">
            ...
            <p>
               Just Dance is a rhythm game where players mimic the motions of an on-screen dancer's 
                choreography for a selected song, using the Wii Remote to judge the player's motions 
                and accuracy. After selecting a song, players are presented with an on-screen dancer, as
                 well as an occasional display of scrolling pictograms representing specific poses. While
                  holding a Wii Remote in their right hand, players follow the motions of the on-screen
                   dancer and their choreographed routine. Players are judged on a ranking scale for the 
                   accuracy of each of their moves in comparison to that of the on-screen dancer, and 
                   receive points. Just Dance can be played by up to four players at once. Along with 
                   standard play, three other modes are included; the "Warm Up" mode serves as a practice
                    mode. In "Strike a Pose" mode, players are instructed at random to freeze (similarly to
                     Red light green light). In "Last One Standing" mode, players are given seven lives; 
                     players lose lives on mistakes, and gain them back after hitting five correct moves
                      in a row.
