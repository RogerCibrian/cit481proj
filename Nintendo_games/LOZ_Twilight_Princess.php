...
div.transbox_loztwilightprincess {
        border: 1px solid black;
        margin: 0rem;
        padding: 0.1 rem;
        height: 235px;
        text-indent: 185px;
        background: url('/Nintendo_games/Wii/220px-The_Legend_of_Zelda_Twilight_Princess_Game_Cover.jpg');
...
<body>
   ...
   <div class="bg"></div>
        <div class="LOZTWILIGHTPRINCESS">
        <div class="transbox_loztwilightprincess">
            <ul>
              <h2>The Legend of Zelda: Twilight Princess</h2>
              <br/>
              <li>Initial Release Date: November 19, 2006 (Wii)  &  December 11, 2006 (GameCube) </li>
              <li>Developed by Nintendo EAD</li>
              <li> Published by Nintendo</li>
               <li>
                <a href="https://www.amazon.com/s?k=The+Legend+of+Zelda%3A+Twilight+Princess+-+Nintendo+Wii&i=videogames&ref=nb_sb_noss">
                <strong>Available in the Amazon Store(Wii link)</strong></a>
               </li>
               <p style="text-indent:195px;">or</p>
               <li>
                <a href="https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=The+Legend+of+Zelda%3A+Twilight+Princess+-+Nintendo+GameCube&_sacat=0&LH_TitleDesc=0&_osacat=0&_odkw=Pokemon+Sun+Nintendo+3DS">
                <strong>Available in the ebay Store (GameCube link)</strong></a>
               </li>
            </ul>
<div class="average">
...
<div class="transbox">
            <p>
      The Legend of Zelda: Twilight Princess is an action-adventure game focused on combat, exploration, and 
                puzzle-solving. The story focuses on series protagonist Link, who tries to prevent Hyrule from being
                 engulfed by a corrupted parallel dimension known as the Twilight Realm. To do so, he takes the 
                 form of both a Hylian and a wolf, and he is assisted by a mysterious creature named Midna. The
                  game takes place hundreds of years after The Legend of Zelda: Ocarina of Time and The Legend of
                   Zelda: Majora's Mask, in an alternate timeline from The Wind Waker.
