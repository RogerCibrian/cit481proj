...
div.transbox_Beyondtwosouls {
	margin: 30px;
        ...
        height: 244px;
        text-indent: 185px;
        background: url('/Playstation_games/Playstation_3_games/Beyond_Two_Souls.jpg');
...
<div class="bg"></div>
        <div class="BeyondTwoSouls">
        <div class="transbox_Beyondtwosouls">
            <ul>
              ...
              <li>Initial Release Date: October 8, 2013</li>
              <li>Developed by Quantic Dream</li>
              <li>Published by Sony Interactive Entertainment </li>
               <li>
                <a href="https://store.playstation.com/en-us/product/UP9000-NPUA81087_00-GBEYONDTWO000001">
...
<div class="transbox">
          <p> 
                From the visionary mind of David Cage, director of the award-winning Heavy 
                Rain, comes the most powerful emotional experience on the PlayStation®3 system. 
                A unique psychological action thriller delivered by A-list Hollywood performances,
                 BEYOND: Two Souls takes you on a thrilling journey across the globe as you play out 
                 the remarkable life of Jodie Holmes. Born with a connection to a mysterious entity 
                 with incredible powers, Jodie was different. In an adventure spanning 15 years of 
                 her life, your actions will determine Jodie's fate as she faces extraordinary 
                 challenges, danger, and heartwrenching loss on a journey to discover the truth of
                  who she is. Beyond: Two Souls promises an emotionally-charged journey unlike any 
                  video game before.
              </p>  
        </div> 
