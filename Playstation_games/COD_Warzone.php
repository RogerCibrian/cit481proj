...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/Playstation_games/CODWarzone.css"/>
...
<div class="bg"></div>
            <div class="COD_Warzone">
            <div class="transbox_codwarzone">
                <ul>
                  ...
                  <br />
                  <br />
                  <li>Initial Release Date: March 10, 2020</li>
                  <li>Developed by Infinity Ward, Raven Software</li>
                  <li>Published by Activision</li>
                   <li>
                    <a href="https://store.playstation.com/en-us/product/UP0002-CUSA08829_00-CODWARZONE000001">
...
<div class="transbox">
           <p> 
                    Call of Duty: Warzone is a free-to-play battle royale video game and is a part of 
                    the 2019 title Call of Duty: Modern Warfare but does not require purchase of it. 
                    Warzone features two primary game modes: Battle Royale and Plunder.The Battle Royale
                     mode is similar to other titles in the genre where players compete in a 
                     continuously shrinking map to be the last player remaining. Players parachute onto 
                     a large game map, where they encounter other players. As the game progresses and 
                     players are eliminated, the playable area shrinks forcing the remaining players
                      into tighter spaces. In Warzone, the non-playable areas become contaminated with 
                      a green gas that depletes health and eventually kills the player if they do not 
                      return to the safe playable area. 
                    </p>
                      <p>
                      In the Plunder mode, teams have to search for stacks of Cash scattered around 
                      the map to accumulate $1 million. Once found, the game goes into overtime, multiplying
                       all Cash sums by 1.5. The team who has gathered the most money when the clock runs 
                       out is declared the winner. Players respawn automatically in this gamemode.
                  </p>  
        </div> 
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line213" rows="2" name="comment"
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
       <!---external JS script: dislike container, likes container, form-container, userform  --->
	    <script type="text/javascript" src='../js/Playstation_games/COD_Warzone.js'></script>
</body>
</html>