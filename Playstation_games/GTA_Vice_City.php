...
<html lang="en">
  ...
  <link rel="stylesheet" href="../css/Playstation_games/GTA_Vice_City.css"/>
...
<div class="bg"></div>
        <div class="GTA_VICE_CITY">
        <div class="transbox_gtavicecity">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: October 27, 2002</li>
              <li>Developed by Rockstar North, War Drum Studios, and Rockstar Vienna</li>
              <li>Published by Rockstar Games</li>
               <li>
                <a href="https://store.playstation.com/en-us/product/UP9000-NPUD20552_00-0000000000000000?smcid=pdc%3Aus-en%3Aweb-pdc-games-grand-theft-auto-vice-city-ps2%3Aleadproductinfo-buy-download%3Anull%3A">
...
<div class="transbox">
            <p> 
              Grand Theft Auto: Vice City is set in 1986 within the fictional Vice City, based on 
              Miami, the game follows mobster Tommy Vercetti following his release from prison. After 
              he is caught up in an ambushed drug deal, he seeks out those responsible while building
               a criminal empire and seizing power from other criminal organisations in the city. The 
               game is played from a third-person perspective, and its world is navigated on foot or 
               by vehicle. The open world design lets the player freely roam Vice City, consisting of 
               two main islands. The game's plot is based on multiple real-world people and events in
                Miami such as Cubans, Haitians, and biker gangs, the 1980s crack epidemic, the Mafioso 
                drug lords of Miami, and the dominance of glam metal. The game was also influenced by 
                the film and television of the era, including Scarface and Miami Vice.
...
<?php $nope4 = 0; ?>
    ...
    <!---external JS script: dislike container, likes container, form-container, userform  --->
	  <script type="text/javascript" src='../js/Playstation_games/GTA_Vice_City.js'></script>
</body>
</html>