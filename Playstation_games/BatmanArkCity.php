...
<html lang="en">
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Playstation_games/batman_arkcity.css"/>
...
<div id="content-wrap">
        ...
        <div class="transbox_BatmanArk">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: October 18, 2011</li>
              <li>Developed by Rocksteady Studios</li>
              <li>Published by Warner Bros. Interactive Entertainment </li>
               <li>
                <a href="https://store.playstation.com/en-us/product/UP1018-NPUB30754_00-ARKHAMCITY00GAME">
...
<div class="transbox">
<p> 
                No escape from Arkham City...the sprawling super-prison in the heart of Gotham 
                City, home to its most violent thugs and infamous super villains. With the lives 
                of the innocent at stake, only one man can save them and bring justice to the 
                streets of Gotham City...The Batman. The game is presented from the third-person 
                perspective with a primary focus on Batman's combat and stealth abilities, detective 
                skills, and gadgets that can be used in both combat and exploration. Batman can 
                freely move around the Arkham City prison, interacting with characters and undertaking
                 missions, and unlocking new areas by progressing through the main story or obtaining 
                 new equipment.
              </p> 
        </div> 
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line219" rows="2" name="comment"
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	    <script type="text/javascript" src='../js/Playstation_games/BatmanArkCity.js'></script>
</body>
</html>