...
<html lang="en">
  ...
  <link rel="stylesheet" href="../css/Playstation_games/GTA_III.css"/>
...
<div class="bg"></div>
        <div class="GTAIII">
        <div class="transbox_gtaiii">
            <ul>
              <h2>Grand Theft Auto III</h2>
              <br />
              <br />
              <li>Initial Release Date: October 22, 2001</li>
              <li>Developed by Rockstar Games and Rockstar North</li>
              <li>Published by Rockstar Games</li>
               <li>
                <a href="https://store.playstation.com/en-us/product/UP9000-NPUD20062_00-0000000000000000?smcid=pdc%3Aus-en%3Aweb-pdc-games-grand-theft-auto-iii-ps2%3Aleadproductinfo-buy-download%3Anull%3A">
                <strong>Available in the Playstation Store</strong></a>
               </li> 
              <li>
              <p class="p_text_store">or</p> 
              <li>
                <a  href="https://www.ebay.com/b/Video-Games/139973?Game%2520Name=Grand%2520Theft%2520Auto%2520III&Platform=Sony%2520PlayStation%25202&Video%2520Game%2520Name=Grand%2520Theft%2520Auto%2520III&rt=nc">
...
<div class="transbox">
            <p> 
              Grand Theft Auto III is set within the fictional Liberty City, loosely based on New 
              York City, the game follows a criminal named Claude as he attempts to exact revenge 
              on his girlfriend for betraying and leaving him for dead, and quickly becomes entangled 
              in a world of gangs, crime and corruption. The game is played from a third-person 
              perspective and its world is navigated on foot or by vehicle. The open world design 
              lets players freely roam the three islands of Liberty City.
               Players complete missions—linear scenarios with set objectives—to progress through 
              the story. It is possible to have several active missions running at one time, as 
              some missions require players to wait for further instructions or events. Outside of 
              missions, players can freely roam the game's open world, and have the ability to 
              complete optional side missions. Liberty City is composed of three boroughs: 
              Portland, Staunton Island, and Shoreside Vale; the latter two areas become unlocked 
...
<?php $nope4 = 0; ?>
    ...
    <!---external JS script: dislike container, likes container, form-container, userform  --->
	  <script type="text/javascript" src='../js/Playstation_games/GTA_III.js'></script>
</body>
</html>