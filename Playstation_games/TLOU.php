...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/Playstation_games/TLOU.css"/>
...
<div class="bg"></div>
        ...
        <div class="transbox_tlou">
            <ul>
              ...
              <li>Initial Release Date: June 14, 2013</li>
              <li>Developed by Naughty Dogs</li>
              <li>Published by Sony Interactive Entertainment</li>
               <li>
                <a href="https://store.playstation.com/en-us/product/UP9000-NPUA80960_00-THELASTOFUSDIG01">
...
<div class="transbox">
             <p> 
                In The Last of Us, players control Joel, a smuggler tasked with escorting 
                a teenage girl, Ellie, across a post-apocalyptic United States. The Last of 
                Us is played from a third-person perspective. The player traverses post-apocalyptic 
                environments such as towns, buildings, forests, and sewers to advance the story. 
                Players use firearms and improvised weapons, and can use stealth to defend against 
                hostile humans and cannibalistic creatures infected by a mutated strain of the 
                Cordyceps fungus. In the online multiplayer mode, up to eight players engage in 
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	    <script type="text/javascript" src='../js/Playstation_games/TLOU.js'></script>
</body>
</html>