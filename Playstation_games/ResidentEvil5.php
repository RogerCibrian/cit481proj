...
<html lang="en">
  ...
  <link rel="stylesheet" href="../css/Playstation_games/ResidentEvil5.css"/>
...
<div class="bg"></div>
        <div class="ResidentEvil5">
        <div class="transbox_residentevil5">
            <ul>
              ...
              <li>Initial Release Date: March 5, 2009</li>
              <li>Developed by Capcom</li>
              <li>Published by Capcom </li>
               <li>
                <a href="https://store.playstation.com/en-us/product/UP0102-NPUB30564_00-HDDBOOT0100A0100">
...
<div class="transbox">
             <p> 
                The Umbrella Corporation and its crop of lethal viruses have been destroyed 
                and contained. But a new, more dangerous threat has emerged. In 2009, 4 years  
                after surviving the events in Raccoon City, Chris Redfield has been fighting 
                the scourge of bio-organic weapons all over the world. Now a member of the 
                Bio-terrorism Security Assessment Alliance (BSSA), Chris is sent to Africa 
                to investigate a biological agent that is transforming the populace into 
                aggressive and disturbing creatures. Joined by another local BSSA agent, Sheva 
                Alomar, the two must work together to solve the truth behind the disturbing
                 turn of events. 
            </p> 
        </div> 
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	  <script type="text/javascript" src='../js/Playstation_games/residentevil5.js'></script>
</body>
</html>