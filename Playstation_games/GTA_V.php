...
<html lang="en">
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Playstation_games/GTA_V.css"/>
...
<div class="bg"></div>
        ...
        <div class="transbox_gtav">
            <ul>
              ...
              <li>Initial Release Date: September 17, 2013</li>
              <li>Developed by Rockstar Games and Rockstar North</li>
              <li>Published by Rockstar Games </li>
               <li>
                <a href="https://store.playstation.com/en-us/product/UP1004-NPUB31154_00-GTAVDIGITALDOWNL">
...
<div class="transbox">
            <p> 
                In the sprawling, sun-soaked city of Los Santos, three very
                 different criminals risk everything in a series of daring and 
                 dangerous heists that could set them up for life. Grand Theft Auto V is an 
                 action-adventure game played from either a third-person or first-person 
                 perspective. Players complete missions—linear scenarios with set
                  objectives—to progress through the story. Outside of the missions, 
                  players may freely roam the open world. Composed of the San Andreas 
                  open countryside area, including the fictional Blaine County, and the 
                  fictional city of Los Santos, the world is much larger in area than earlier
                   entries in the series. It may be fully explored after the game's beginning 
                   without restriction, although story progress unlocks more gameplay content. 
              </p> 
        </div> 
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	  <script type="text/javascript" src='../js/Playstation_games/GTA_V.js'></script>
</body>
</html>