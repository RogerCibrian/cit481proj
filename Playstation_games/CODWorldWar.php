...
<html lang="en">
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Playstation_games/CODWorldWar.css"/>
...
<div class="bg"></div>
        ...
        <div class="transbox_codww">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: November 11, 2008</li>
              <li>Developed by Treyarch</li>
              <li>Published by Activision</li>
               <li>
                <a href="https://www.walmart.com/ip/Call-Of-Duty-World-At-War-PS2/20467942">
...
<div class="transbox">
            <p> 
              The narrative for the campaign mode focuses on the Pacific and Eastern Front theaters 
              of World War II, involving the United States, Empire of Japan, Soviet Union, and 
              Nazi Germany. It is told from the perspectives of Marine Raider Private C. Miller, 
              US Navy Petty Officer Locke and Red Army soldier Private Dimitri Petrenko, and is
               based on several historical battles.
            </p>
               <p>
              It was the first game in the Call of Duty series to feature zombies. The mode consists 
              of 1-4 players fighting an unlimited number of waves of Nazi zombies. Players can work 
              together with other people to kill the zombies in a "co-op" (cooperative) mode either 
              offline with 1-2 players or online with 2-4 players. The players gain points by injuring
               or killing the zombies or repairing boarded-up windows, which are used to remove 
               blockages inside the bunker and to gain access to more useful weapons than the 
               starting M1911 pistol and unlock more rooms. Zombies continually break the windows 
               to gain entrance and to down the players; when all players are damaged enough to 
               fall, the game is over. The three aforementioned extra maps for the Nazi Zombie 
               game mode were added with the World at War map packs. These maps, Verrückt, Shi No 
               Numa and Der Riese added on to the Nacht Der Untoten map which came with the game.
            </p> 
        </div> 
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line215"  rows="2" name="comment"
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	  <script type="text/javascript" src='../js/Playstation_games/CODWorldWar.js'></script>
</body>
</html>