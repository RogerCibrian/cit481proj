...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Playstation_games/fallguys.css"/>
...
<div class="bg"></div>
            ...
            <div class="transbox_fallguys">
                <ul>
                  ...
                  <br />
                  <br />
                  <li>Initial Release Date: February 2, 2020</li>
                  <li>Developed by: Mediatonic</li>
                  <li>Published by: Devolver Digital</li>
                   <li>
                    <a href="https://store.playstation.com/en-us/product/UP3643-CUSA17711_00-FALLGUYSPS4US000">
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
       <!---external JS script: dislike container, likes container, form-container, userform  --->
    	<script type="text/javascript" src='../js/Playstation_games/FallGuys.js'></script>
</body>
</html>