...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/Playstation_games/bionicle.css"/>
...
<div class="bg"></div>
        <div class="Bionicle">
        <div class="transbox_bionicle">
            <ul>
              <h2>Bionicle</h2>
              <br />
              <li>Initial Release Date: September 1, 2003</li>
              <li>Developed by Argonaut Games, Sega, Particle Systems, Rockstar Leeds</li>
              <li>Published by Electronic Arts and Lego Interactive</li>
               <li>
                <a href="https://www.amazon.com/s?k=Bionicle+ps2&i=videogames&ref=nb_sb_noss_2">
                <strong>Available in the Amazon Store</strong></a>
              </li>
              <p class="p_text_store">or</p> 
              <li>
                <a  href="https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=Bionicle+%28PS2%29&_sacat=0&LH_TitleDesc=0&_osacat=0&_odkw=Aliens+vs+Predator%3A+Extinction+%28PS2%29">
...
<div class="transbox">
            <p> 
              The game is based on parts of the movie Bionicle: Mask of Light and other parts 
              of the Bionicle storyline. Basic controls include using shields and light elemental
               blasts to defeat enemies and open canisters. Overall, there are 8 levels in the 
               game including the boss battle against Makuta. due to deadlines, much of the game 
               was dropped. However, all of the characters are playable in the Game Boy Advance 
               version published by THQ. The Mac OS X version of the game was released by Feral 
               Interactive.
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line207" rows="2" name="comment"
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	    <script type="text/javascript" src='../js/Playstation_games/Bionicle.js'></script>
</body>
</html>