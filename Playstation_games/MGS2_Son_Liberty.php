...
div.transbox_mgs2sonsofliberty{
	margin: 30px;
        ...
        height: 244px;
        text-indent: 185px;
        background: url('/Playstation_games/Playstation_2_games/MGS2_Son_of_liberty_cover.jpg');
...
<div class="bg"></div>
        <div class="MGS2_SON_LIBERTY">
        <div class="transbox_mgs2sonsofliberty">
            <ul>
              ...
              <li>Initial Release Date: November 13, 2001</li>
              <li>Developed by Konami</li>
              <li>Published by Konami</li>
               <li>
                <a href="https://www.amazon.com/s?k=Metal+Gear+Solid+2%3A+Sons+of+Liberty+playstation+2&i=videogames&ref=nb_sb_noss">
                <strong>Available in the Amazon Store</strong></a>
               </li> 
              <li>
              <p style="text-indent: 180px;">or</p> 
              <li>
                <a  href="https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2322090.m570.l1313&_nkw=Metal+Gear+Solid+2%3A+Sons+of+Liberty+Sony+PlayStation+2&_sacat=0">
...
<div class="transbox">
            <p> 
              Metal Gear Solid 2: Sons of Liberty is a stealth game where the story revolves around 
              the "Big Shell," a massive offshore clean-up facility seized by a group of terrorists 
              who call themselves the "Sons of Liberty." They demand an enormous ransom in exchange 
              for the life of the President of the United States and threaten to destroy the facility
               and create a cataclysmic environmental disaster if their demands are not met. The 
               motives and identities of many of the antagonists and allies change throughout the 
               course of the game, as the protagonists discover a world-shaking conspiracy constructed
                by a powerful organization known as the Patriots.
            </p> 
        </div> 
