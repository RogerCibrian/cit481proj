...
<html lang="en">
  ...
  <link rel="stylesheet" href="../css/Playstation_games/infamous.css"/>
...
<div class="bg"></div>
        ...
        <div class="transbox_infamous">
            <ul>
              ...
              <li>Initial Release Date: May 26, 2009</li>
              <li>Developed by Sucker Punch Productions</li>
              <li>Published by Sony Interactive Entertainment </li>
               <li>
                <a href="https://store.playstation.com/en-us/product/UP9000-NPUA80480_00-INFAMOUSFULLGAME">
...
<div class="transbox">
            <p> 
                In Infamous, the player controls the protagonist Cole MacGrath, a bike messenger 
                caught in the center of an explosion that devastates several city blocks of the 
                fictional Empire City. The explosion sends the city into chaos while Cole finds 
                himself with new electricity-based super powers. Though the game's story follows 
                Cole using his new abilities to restore some semblance of order to Empire City, 
                the player is given several opportunities to use these powers for good or evil 
                purposes in the game's Karma system. These choices ultimately affect character 
                growth, the reaction of the City's populace towards Cole, and finer elements of 
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	  <script type="text/javascript" src='../js/Playstation_games/infamous.js'></script>
</body>
</html>