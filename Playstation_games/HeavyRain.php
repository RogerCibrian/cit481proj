...
<html lang="en">
  ...
  <link rel="stylesheet" href="../css/Playstation_games/HeavyRain.css"/>
...
<div class="bg"></div>
        ...
        <div class="transbox_heavyrain">
            <ul>
              ...
              <li>Initial Release Date: February 23, 2010</li>
              <li>Developed by Quantic Dream</li>
              <li>Published by Sony Interactive Entertainment </li>
               <li>
                <a href="https://store.playstation.com/en-us/product/UP9000-BCUS98164_00-HEAVYRAIN0000000">
...
<div class="transbox">
            <p> 
                Heavy Rain is an interactive drama and action-adventure game in which the player 
                controls four different characters, from a third-person perspective, involved 
                with the mystery of the Origami Killer.The Origami Killer is a serial murderer 
                who uses extended periods of rainfall to drown his victims. The player interacts 
                with the game by performing actions highlighted on screen related to motions on the 
                controller, and in some cases, performing a series of quick time events. The 
                player's decisions and actions during the game affect the narrative.
              </p> 
        </div> 
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	  <script type="text/javascript" src='../js/Playstation_games/heavyrain.js'></script>
</body>
</html>