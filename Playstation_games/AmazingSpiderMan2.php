...
<html lang="en">
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Playstation_games/amazingspiderman2.css"/>
...
<div class="bg"></div>
            ...
            <div class="transbox_spiderman2">
                <ul>
                  ...
                  <br />
                  <br />
                  <li>Initial Release Date: April 29, 2014</li>
                  <li>Developed by Beenox</li>
                  <li>Published by Activision</li>
                   <li>
                    <a href="https://store.playstation.com/en-us/product/UP0002-CUSA00239_00-AMAZINGSPIDERMDL">
...
<div class="transbox">
<p> 
                    The Amazing Spider-Man 2 is a third person action-adventure video game, set in an open world based 
                    on Manhattan. Players take on the role of Spider-Man and complete 
                    missions—linear scenarios with set objectives—to progress through the 
                    story. The missions are structured in a linear manner, but the player 
                    is free to explore the game's map in between missions and engage in 
                    various side activities. Players have access to all of Spider-Man's 
                    superhuman abilities, including web swinging and wall crawling. The 
                    Web-Rush bullet time mechanic from the game's predecessor also returns 
                    and has been expanded, now allowing players to also do critical 
                    strikes, dodges, and rolls. The combat is smilar to the predecessor, 
                    featuring a freeflow design and counterattacks, and allows Spider-Man 
                    to incapacitate enemies for a few seconds by various means, such as 
                    throwing interactable objects at them, and then subdue them for good
                     by webbing them.   
                  </p>  
        </div> 
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
       <!---external JS script: dislike container, likes container, form-container, userform  --->
	    <script type="text/javascript" src='../js/Playstation_games/AmazingSpiderMan2.js'></script>
</body>
</html>