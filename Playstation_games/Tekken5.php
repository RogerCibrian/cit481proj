...
<html lang="en">
  ...
  <link rel="stylesheet" href="../css/Playstation_games/Tekken5.css"/>
...
<div class="bg"></div>
        <div class="TEKKEN5">
        <div class="transbox_tekken5">
            <ul>
              <h2>Tekken 5</h2>
              <br />
              <br />
              <li>Initial Release Date: February 24, 2005</li>
              <li>Developed by Namco</li>
              <li>Published by Namco, Sony Interactive Entertainment, and ak tronic Software & Services GmbH</li>
               <li>
                <a href="https://www.amazon.com/s?k=Tekken+5+-+PlayStation+2&i=videogames&ref=nb_sb_noss">
                <strong>Available in the Amazon Store</strong></a>
               </li> 
              <li>
              <p class="p_text_store">or</p> 
              <li>
                <a  href="https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2322090.m570.l1313&_nkw=Tekken+5+Sony+PlayStation+2&_sacat=0">
...
<div class="transbox">
            <p> 
              Tekken 5 is set moments after Tekken 4's ending in which after the death of Heihachi 
              Mishima, the fifth King of Iron Fist Tournament began. Tekken 5 lets you join this 
              battle as one of many characters, including three fighters who are new to the Tekken 
              series. This time, the environments feature destructible objects and dangerous obstacles.
              Customize your character with a variety of accessories, such as beanies, glasses, and 
              costumes. Tekken 5 also allowed players to customize their fighter for the first 
              time, allowing them to change the colors of their outfits, buy additional 
              costumes (only available to a few characters), and equip them with items by using money
               gained from playing the Story, Survival, Time Attack, the side-story Devil Within, and 
               Arcade Battle modes. Beat the game with each character to learn his or her story.
            </p> 
        </div> 
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	    <script type="text/javascript" src='../js/Playstation_games/tekken5.js'></script>
</body>
</html>