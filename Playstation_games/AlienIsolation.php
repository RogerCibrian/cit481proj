   ...
   <style>
      ...
      * {
      ...
      html {
        ...
        div.transbox_alieniso {
              margin: 30px;
                border: 1px solid black;
                margin: 0rem;
                padding: 0.1 rem;
                text-indent: 190px;
                background: url('/Playstation_games/Playstation_4_games/alien-isolation.jpg');
...
<div class="bg"></div>
            <div class="AlientIsolation">
            <div class="transbox_alieniso">
                <ul>
                  ...
                  <br />
                  <br />
                  <li>Initial Release Date: October 6, 2014</li>
                  <li>Developed by Creative Assembly</li>
                  <li>Published by Sega</li>
                   <li>
                    <a href="https://store.playstation.com/en-us/product/UP0177-CUSA00363_00-ALIENISOLATIONP4">
...
<div class="transbox">
		<p> 
                    Alien: Isolation is a single-player action-adventure game with emphasis on stealth 
                    and survival horror features. The player controls Amanda Ripley from a first-person 
                    spective,and must explore a space station and complete objectives while avoiding, 
                    outsmarting and defeating enemies. Objectives range from activating computers to 
                    collecting certain items or reaching a specific area in the game. The player can 
                    run, climb ladders, sneak into vents, crouch behind objects to break the line of 
                    sight with enemies, and peek over or lean around to gain view. The player also has 
                    the ability to go under tables or inside lockers to hide from enemies. Amanda 
                    encounters several antagonists over the course of the game, including hostile humans 
                    and androids. These can be defeated with gunplay or other offensive means. The main 
                    antagonist, an Alien creature, pursues the player throughout the game. The Alien 
                    creature cannot be defeated, requiring the player to use stealth tactics in order 
                    to survive.
                  </p> 
        </div> 
...
<!-- end of likes section for parent comments-->  <!--start of likes section -->
  <div class="LikeAndReplies">
<!-- form for likes -->
<form class="likesContainer" action="../likesdislikes.php" method="POST" id="l<?php echo $num; ?>">
<input type="hidden" id="input1" value="1" name="input1">
...
</div><!-- start of likes for replies-->
        <div class="LikeAndReplies2">
<!-- form for likes for replies-->
<form class="likesContainer" action="../likesdislikes.php" method="POST" id="e<?php echo $num; ?>">
<input type="hidden" id="input1" value="1" name="input1">
