...
<html lang="en">
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Playstation_games/deathstranding.css"/>
...
<div class="bg"></div>
            <div class="DeathStranding">
            <div class="transbox_deathstranding">
                <ul>
                  ...
                  <br />
                  <br />
                  <li>Initial Release Date: November 8, 2019</li>
                  <li>Developed by Kojima Productions</li>
                  <li>Published by Sony Interactive Entertainment</li>
                   <li>
                    <a href="https://store.playstation.com/en-us/product/UP9000-CUSA11260_00-DEATHSTRAND00001">
...
<div class="transbox">
            	<p> 
                    The game is set in the United States following a cataclysmic event which 
                    caused destructive creatures to begin roaming the Earth. Players control Sam 
                    Porter Bridges (Norman Reedus), a courier tasked with delivering supplies to 
                    isolated colonies and reconnecting them via a wireless communications network.
                     The player's main enemies include otherworldly creatures known as 
                     "beached things" (BTs), MULE (a cult of rogue, bandit-like porters influenced 
                     by an obsession with cargo, who attempt to steal deliveries so they can deliver 
                     it themselves), and Demens, MULEs who have begun killing porters to claim their 
                     cargo. BTs are surrounded by a rain known as "timefall", which damages the 
                     player's armor and cargo by speeding up their deterioration. BTs are normally 
                     invisible, but Sam's suit is equipped with a robotic sensor that points towards
                      nearby BTs, and the player can then scan the area to reveal them.
                  </p> 
        </div> 
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	  <script type="text/javascript" src='../js/Playstation_games/DeathStranding.js'></script>
</body>
</html>