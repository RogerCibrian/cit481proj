...
<html lang="en">
  ...
  <link rel="stylesheet" href="../style2.css" />
   ...
   <link rel="stylesheet" href="../css/Playstation_games/GTA_san_andreas.css"/>
...
<div class="bg"></div>
        <div class="GTA_SAN_ANDREAS">
        <div class="transbox_gtasanandreas">
            <ul>
              ...
              <li>Initial Release Date: October 26, 2004</li>
              <li>Developed by Rockstar Games, Rockstar North, and War Drum Studios</li>
              <li>Published by Rockstar Games</li>
               <li>
                <a href="https://www.amazon.com/Grand-Theft-Auto-San-Andreas-PlayStation/dp/B0001VGFK2">
                <strong>Available in the Amazon Store</strong></a>
               </li> 
              <li>
              <p class="p_text_store">or</p> 
              <li>
                <a  href="https://www.ebay.com/sch/i.html?_from=R40&_trksid=p2334524.m570.l1313&_nkw=grand+theft+auto+san+andreas+playstation+2&_sacat=0&LH_TitleDesc=0&_osacat=0&_odkw=grand+theft+aut+san+andreas+playstation+2">
...
<div class="transbox">
            <p> 
              Grand Theft Auto: San Andreas is set within an open world environment that players 
              can explore and interact with at their leisure, focuses on the story of former gangster
               Carl "CJ" Johnson, who is brought back home by the death of his mother, only to become 
               involved in a long journey that sees him exploring the fictional U.S. state of San 
               Andreas, which is heavily based on California and Nevada. The game features references 
               to many real-life elements of the world, such as its cities, regions, and 
               landmarks, with its plot heavily based on several real-life events in Los Angeles in 
               the early 1990s, including the rivalry between real-life street gangs, the 1980s-early 
               1990s crack epidemic, the LAPD Rampart scandal, and the 1992 Los Angeles riots. San 
               Andreas brought with it new elements of gameplay that would be later incorporated in 
               future titles, including RPG-style mechanics, customisation options with both clothing
                and vehicle appearances, a vast array of activities and mini-games, and the inclusion
                 of gambling games.
            </p> 
        </div> 
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line216" rows="2" name="comment"
...
<?php $nope4 = 0; ?>
    ...
    <!---END OF FOOTER-->
     <!---external JS script: dislike container, likes container, form-container, userform  --->
	  <script type="text/javascript" src='../js/Playstation_games/GTA_san_andreas.js'></script>
</body>
</html>