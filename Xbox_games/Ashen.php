...
div.transbox_ashen {
        ...
        height: 277px;
        text-indent: 165px;
        background: url('/Xbox_games/Xbox_One_games/Ashen_cover.png');
...
<div class="bg"></div>
        ...
        <div class="transbox_ashen">
            <ul>
              ...
              <li>Developed & Published by Studio A44</li>
               <li>
                <a href="https://www.microsoft.com/en-us/p/ashen/BNXLPPCVS0HN?activetab=pivot:overviewtab">
