...
<html lang="en">
  ...
  <link rel="stylesheet" href="../css/Xbox_games/MotoGP07.css"/>
</head>
<body>
	 ...
	 <div class="bg"></div>
        ...
        <div class="transbox_motogp07">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: August 24, 2007</li>
              <li>Developed by Black Rock Studio & Published by Capcom, THQ</li>
               <li>
                <a href="https://www.amazon.com/MotoGP-07-DVD-pc/dp/B000YEAGUG">
                <strong>Available on Xbox 360</strong></a>
               </li> 
            </ul>
...
<div class="transbox">
			...
			MotoGP '07 puts you behind the handlebars for the most thrilling motor sport in the world!
			Feel the excitement and energy of the fans and media, as you go into the game world like never before.
			Building on the success of MotoGP '06, the game focuses on expanding the atmosphere and depth of the series, capturing the passion, excitement and spectacle of the sport, as well as rounding out the whole experience into the most accomplished racing game
