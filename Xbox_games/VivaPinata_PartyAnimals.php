...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/Xbox_games/VivaPinata_PartyAnimals.css"/>
...
<body>
	...
	<div class="bg"></div>
        <div class="vivapinata">
        <div class="transbox_vivapinata">
            <ul>
              <h2>Viva Pinata: Party Animals</h2>
              <br />
              <br />
              <br />
              <br />
              <br />
              <li>Initial Release Date: October 30, 2007</li>
              <li>Developed by Volition & Published by THQ</li>
               <li>
                <a href="https://www.gamestop.com/video-games/xbox-360/games/products/viva-pinata-party-animals/10132367.html">
...
<div class="transbox">
			...
			Compete in a variety of zany battles and races in the social party game Viva Piñata: Party Animals.
			Control the fame, fortune, and destiny of all your favorite characters from Viva Piñata: Fergy Fudgehog, Paulie Pretztail, Franklin Fizzlybear, and Hudson Horstachio.
			It's party time! A game of Party Animals consists of three or more race events, each followed by one or more randomly selected challenge mini-games (depending on selected game length). The goal is to be the player who has earned the most candy ("Candiosity") after the final challenge is completed. Games always feature four player characters, although only one of these need be human-controlled. Multiple individuals can play on a single console (causing races to be conducted split-screen), or players can play online via Xbox Live.
      </p> 
      <p>
