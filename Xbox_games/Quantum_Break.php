  ...
  <link rel="stylesheet" href="../style2.css" />
   <style>
      ...
      div.transbox_quantumbreak{
              ...
              height: 277px;
              text-indent: 185px;
              background: url('/Xbox_games/Xbox_One_games/220px-Quantum_Break_cover.jpg');
...
<body>
    ...
    <!----end of Navigation Bar-->
	 <div class="bg"></div>
        <div class="quantumbreak">
        <div class="transbox_quantumbreak">
            <ul>
              <h2>Quantum Break</h2>
              <br />
              <br />
              ...
              <br />
              <br />
              <li>Initial Release Date: April 5, 2016</li>
              <li>Developed by Remedy Entertainment & Published by Microsoft Studios</li>
               <li>
                <a href="https://www.microsoft.com/en-us/p/quantum-break/bpndkqn84n6l?activetab=pivot:overviewtab">
...
<div class="transbox">
			...
			The other uses these new abilities to attempt to defeat him – and fix time before it tears itself irreparably apart.
