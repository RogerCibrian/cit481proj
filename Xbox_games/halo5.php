...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/Xbox_games/halo5.css"/>
	...
	<div class="bg"></div>
        ...
        <div class="transbox_halo5">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: October 27, 2015</li>
              <li>Developed by 343 Industries & Published by Microsoft Studios</li>
               <li>
                <a href="https://www.microsoft.com/en-us/p/halo-5-guardians/brrc2bp0g9p0?activetab=pivot:overviewtab">
                <strong>Available in Microsoft Store for PC and Xbox One</strong></a>
               </li> 
            </ul>
...
<div class="transbox">
			...
			Halo 5: Guardians delivers epic multiplayer experiences that span multiple modes, full-featured level building tools, and a new chapter in the Master Chief saga.
			And now with Xbox One X, players can experience enhanced visuals, up to 4K resolution, increased visual details, and improved graphic fidelity that makes the game look better than ever before, all while maintaining a consistent 60FPS for the smoothest gameplay possible.
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line201" rows="2" name="comment"
