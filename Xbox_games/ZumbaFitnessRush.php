...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/Xbox_games/ZumbaFitnessRush.css"/>
...
<body>
    ...
    <!----end of Navigation Bar-->
	 <div class="bg"></div>
        <div class="zumbafitness2">
        <div class="transbox_zumbafitness2">
            <ul>
              <h2>Zumba Fitness Rush</h2>
              <br />
              <br />
              <br />
              <br />
              ...
              <li>Developed by Iron Galaxy Studios & Published by Microsoft Studios<li>
               <li>
                <a href="https://www.amazon.com/Zumba-Fitness-Kinect-Xbox-360/dp/B002I0H7K6">
                <strong>Available for Xbox 360</strong></a>
               </li> 
            </ul>
...
<div class="transbox">
			...
			Zumba Fitness uses the motion-sensing capabilities of the Kinect sensor to bring the steamy, calorie-burning moves of Zumba to the Xbox 360.
			The game's primary play mechanic is the replication by player(s) in real-time of dance moves that are demonstrated by an on-screen virtual instructor. 
			The body mapping capabilities of Microsoft Kinect allows this to occur without the need for a controller, unlike other versions of the game.
			...
			Together with four-player support -- both locally and online -- that allows friends to join in the workout, and an ever-present, infectious Latin groove, players have all that they need to dance the weight off and have a blast doing it.
			</p>
        </div> 
