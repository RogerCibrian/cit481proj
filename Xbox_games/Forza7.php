...
div.transbox_forza7 {
        ...
        height: 277px;
        text-indent: 240px;
        background: url('/Xbox_games/Xbox_One_games/Forza_7_art.jpg');
	...
	<div class="bg"></div>
        ...
        <div class="transbox_forza7">
            <ul>
              ...
              <li>Developed & Published by Turn 10 Studios</li>
               <li>
                <a href="https://www.xbox.com/en-US/games/forza-7">
