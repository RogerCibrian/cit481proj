...
div.transbox_forza4{
        ...
        height: 277px;
        text-indent: 220px;
        background: url('/Xbox_games/Xbox360_games/Forza_Motorsport_4_cover.jpg');
	...
	<div class="bg"></div>
        ...
        <div class="transbox_forza4">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: October 11, 2011</li>
              <li>Developed by Turn 10 Studios & Published by Microsoft Studios</li>
               <li>
                <a href="https://www.gamestop.com/video-games/xbox-360/games/products/forza-4/10089166.htmll">
