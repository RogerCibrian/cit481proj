...
div.transbox_acecombat6{
        ...
        height: 277px;
        text-indent: 230px;
        background: url('/Xbox_games/Xbox360_games/ace-combat-6-fires-of-liberation-wallpaper.jpg');
...
<body>
 ...
 <div class="bg"></div>
        <div class="acecombat6">
        <div class="transbox_acecombat6">
            <ul>
              <h2>Ace Combat 6</h2>
              <br />
              <br />
              ...
              <br />
              <br />
              <li>Initial Release Date: October 23, 2007</li>
              <li>Developed by Project Aces & Published by Namco Bandai</li>
               <li>
                <a href="https://www.gamestop.com/video-games/xbox-360/games/products/ace-combat-6-fires-of-liberation/10064996.html">
                <strong>Available Xbox 360 and Xbox One</strong></a>
               </li> 
            </ul>
<div class="average">
...
<div class="transbox">
			 <p> 
			Players can get in the cockpits of their favorite authentically detailed combat aircrafts and command the allied assault force of aerial, naval, and ground combat units.
			In addition, players will engage in fierce combat at an unprecedented scale and intensity as up to six massive conflicts unfold at once at multiple locations in war zones rendered in photorealistic detail.
			For the first time in the Ace Combat franchise, players can prove their supremacy on a global scale in the intense multi-player online mode via Xbox Live!!
			Break the sound barrier and soar 360 degrees through the sky as battles and drama unfold around you on an unprecedented epic scale!
			</p> 
        </div> 
