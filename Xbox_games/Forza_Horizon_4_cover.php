...
div.transbox_forzahorizon4 {
        ...
        height: 277px;
        text-indent: 240px;
        background: url('/Xbox_games/Xbox_One_games/Forza_Horizon_4.jpg');
...
<div class="bg"></div>
        <div class="forzahorizon4">
        <div class="transbox_forzahorizon4">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: September 28, 2018</li>
              <li>Developed & Published by Turn 10 Studios & Playground Games</li>
               <li>
