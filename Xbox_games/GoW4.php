...
div.transbox_gearsofwar4{
        ...
        height: 277px;
        text-indent: 250px;
        background: url('/Xbox_games/Xbox_One_games/Gears_of_War_4.jpg');
...
<body>
	...
	<div class="bg"></div>
        <div class="gearsofwar4">
        <div class="transbox_gearsofwar4">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: October 11, 2016</li>
              <li>Developed by The Coalition & Published by Microsoft Studios</li>
               <li>
                <a href="https://www.xbox.com/en-US/games/gears-of-war-4">
