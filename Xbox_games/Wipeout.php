...
<html lang="en">
  ...
  <link rel="stylesheet" href="../css/Xbox_games/Wipeout.css"/>
...
<body>
    ...
    <!----end of Navigation Bar-->
	 <div class="bg"></div>
        <div class="wipeout">
        <div class="transbox_wipeout">
            <ul>
              <h2>Wipeout: In The Zone</h2>
              <br />
              <br />
              <br />
              <br />
              <br />
              <li>Initial Release Date: December 25, 2010</li>
              <li>Developed & Published by Activision</li>
               <li>
                <a href="https://www.amazon.com/Wipeout-Zone-Xbox-360/dp/B004T7PWZ8">
...
<div class="transbox">
			...
			Wipeout: In the Zone is a Party game exclusive for Xbox 360 that utilizes the full body tracking capabilities of the Kinect Sensor for Xbox 360 (required for play) to bring the over-the-top, physical obstacle course fun of the hit television show Wipeout to life on your game console like you never thought possible.
			Features include: local 4-person multiplayer support, unlockable characters and brand new episodes, replay functionality and the ability to use your Xbox LIVE avatars in-game.
...
<!--review tables has to be altered to make rating an optional field -->
	 ...
	 <input type='hidden' name='page_id' value="<?php echo $page; ?>">
	<textarea class="textarea_line203" rows="2" name="comment"
