...
div.transbox_ridgeracer6{
        ...
        height: 277px;
        text-indent: 185px;
        background: url('/Xbox_games/Xbox360_games/ridge-racer-game-cover.png');
...
<body>
    ...
    <!----end of Navigation Bar-->
	 <div class="bg"></div>
        <div class="ridgeracer6">
        <div class="transbox_ridgeracer6">
            <ul>
              <h2>Ridge Racer 6</h2>
              <br />
              <br />
              ...
              <br />
              <br />
              <li>Initial Release Date: November 22, 2005</li>
              <li>Developed & Published by Namco</li>
               <li>
                <a href="https://www.gamestop.com/video-games/xbox-360/games/products/ridge-racer-6/10040052.html">
...
<div class="transbox">
			...
			Blast through hairpin turns at over 150 mph as beautiful high definition graphics and scintillating sounds assault your senses.
			Ridge Racer 6 utilizes the power of the next generation hardware to deliver exhilarating drift racing gameplay at even more extreme speeds plus Xbox Live features.
