...
<script src="https://kit.fontawesome.com/961faa2e94.js" crossorigin="anonymous"></script>
  ...
  <link rel="stylesheet" href="../css/Xbox_games/Sunset_Overdrive.css"/>
...
<body>
	...
	<div class="bg"></div>
        <div class="sunsetoverdrive">
        <div class="transbox_sunsetoverdrive">
            <ul>
              <h2>Sunset Overdrive</h2>
              <br />
              <br />
              <br />
              <br />
              <br />
              <li>Initial Release Date: October 28, 2014</li>
              <li>Developed by Insomniac Games & Published by Microsoft Studios</li>
               <li>
                <a href="https://insomniac.games/game/sunset-overdrive/">
...
<div class="transbox">
			...
			Sunset Overdrive is an open-world playground of post-apocalyptic possibilities.
			Vault, grind & wall-run while using a deadly & unconventional arsenal.
			With hyper-agility, unique weapons, & customizable abilities, it rewrites the rules of shooters while delivering an irreverent adventure.
