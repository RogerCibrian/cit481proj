...
div.transbox_saintsrow{
        ...
        height: 277px;
        text-indent: 200px;
        background: url('/Xbox_games/Xbox360_games/Saints_Row_Box_Art.jpg');
	 ...
	 <div class="bg"></div>
        ...
        <div class="transbox_saintsrow">
            <ul>
              ...
              <br />
              <br />
              <li>Initial Release Date: August 29, 2006</li>
              <li>Developed by Volition & Published by THQ</li>
               <li>
                <a href="https://www.gamestop.com/video-games/xbox-360/games/products/saints-row/10039502.html">
...
<div class="transbox">
			...
			Welcome to Stilwater, a city where the streets are everything but tranquil.
			Divided by rivaling gangs, you'll need to adopt savvy street smarts to build respect, make money and gain notoriety, let alone stay alive.
			As a member of the 3rd St. Saint's, you need to push back against a city looking to wipe you out, in order to rise up the ranks and eventually control the streets.
			If it takes theft, extortion or tried and true brute force, then that's what ya gotta do. Only then will you rule the streets.
